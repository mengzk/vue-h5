  ...
  <div class="page-content">
    <div class="scroll">
      ...
      <el-form class="form-box" :model="formModel" :rules="rules" ref="formRef">
        ...
        <el-col class="form-row">
          <el-form-item label="公司简称:" prop="short">
            <el-input
          ...
          <el-form-item label="管理代理账号:" prop="account">
      ...
      <el-checkbox-group class="checkbox-group" v-model="formModel.auth">
        <el-checkbox size="large" label="lab1" value="level1"
          >应用权限</el-checkbox
        >
        <el-checkbox size="large" label="lab2" value="level2"
          >应用权限</el-checkbox
        >
        <el-checkbox size="large" label="lab5" value="level5"
          >应用权限</el-checkbox
        >
      </el-checkbox-group>
    </div>
...
const rules = reactive({
  ...
  short: [
    {
      required: true,
      message: "Please input Activity short name",
      trigger: "blur",
    },
